...
class PopupSemece extends React.Component {
  constructor(props){
    super(props);
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevState.travaux !== this.state.travaux) {
      ...
      this.props.ListSemence(this.state.travaux)
      this.props.ListValues(this.state.Values)
    }
