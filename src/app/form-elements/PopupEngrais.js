...
class PopupEngrais extends React.Component {
  constructor(props){
    super(props);
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevState.travaux !== this.state.travaux) {
      ...
      this.props.ListEngrais(this.state.travaux)
      this.props.ListVal(this.state.Values)
    }
  ...
  async fetch_data() {
    ...
    this.data1 = await fetch("http://localhost:3001/getEngrais",{
                  method:'POST',
